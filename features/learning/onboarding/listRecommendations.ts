...
// Names a reversed list in its own direction, localized in the known language,
// e.g. "Arabic - English" — never the source name with a "(ar / en)" suffix.
// Mirrors buildAutogeneratedListName used by the autogenerate path.
export function buildReversedListName(languageFrom: string, languageTo: string): string {
