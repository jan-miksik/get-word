...
// Subscribing to such a list would study it in the wrong direction, so instead we
// autogenerate a shared reversed list (which swaps text + audio) in the requested
// direction and reuse it for future users of the same pair.
