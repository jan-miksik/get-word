...
function ListsPageContent() {
  ...
  const handlePreviewAutogeneratedListRepair = useCallback(
    (listId: string) => previewAutogeneratedListRepair(listId),
    [],
  );

  const handleRepairAutogeneratedList = useCallback(
    async (listId: string, preview?: RepairAutogeneratedListPreview, selectedRepairItemIds?: string[]) => {
      try {
        ...
        setError(err instanceof Error ? err.message : t('lists.repairAutogeneratedFailed'));
      }
    },
